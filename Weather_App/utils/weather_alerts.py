...
def save_alerts_to_db(location_obj, alerts_data):
    ...
    #xóa tất cả alerts cũ của location này
...
SAFETY_ADVICE = {
    ...
    'cold_wave': {
        ...
        'advice': [
            ...
            'Cẩn thận với sương muối, đường trơn'
        ]
    },
    'extreme_cold': {
        'icon': 'fa-snowflake',
    ...
    'thunderstorm': {
        ...
        'advice': [
            ...
            'Xuống nơi trũng nếu ở ngoài trời'
        ]
    },
    'fog': {
        'icon': 'fa-smog',
        ...
        'advice': [
            ...
            'Kiểm tra chuyến bay trước khi đi',
